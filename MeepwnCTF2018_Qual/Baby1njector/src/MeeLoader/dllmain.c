...
HMEMORYMODULE LoadML(InternalInfo *Iinfo)
{
    return MemoryLoadLibraryEx(Iinfo->RemoteDllSegment, (SIZE_T)Iinfo->LenghtRemoteDllSegment, MemoryDefaultAlloc, MemoryDefaultFree, MemoryDefaultLoadLibrary, MemoryDefaultGetProcAddress, MemoryDefaultFreeLibrary, NULL);
}
...
FARPROC GetPA(HMEMORYMODULE module, LPCSTR name)
{
